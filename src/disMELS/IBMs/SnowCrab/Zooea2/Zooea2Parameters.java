...
public class Zooea2Parameters extends AbstractLHSParameters {
    ...
    protected final void createMapToParameters() {
        ...
        key = PARAM_minStageDuration;     mapParams.put(key,new IBMParameterDouble(key,key,0.0006));
        key = PARAM_maxStageDuration;     mapParams.put(key,new IBMParameterDouble(key,key,365.0));
        key = PARAM_minWeight;            mapParams.put(key,new IBMParameterDouble(key,key,0.006));
        key = PARAM_randomizeTransitions; mapParams.put(key,new IBMParameterBoolean(key,key,false));
        key = PARAM_initialWeight;        mapParams.put(key,new IBMParameterDouble(key,key,0.0002));
    }
