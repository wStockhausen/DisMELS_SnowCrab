...
/**
 * DisMELS class encapsulating attributes for immature female snow crab.
...
public class FemaleImmatureAttributes extends AbstractBenthicStageAttributes {
...
//    public static final String PROP_size   = "size [mm]";
    ...
    private static final Logger logger = Logger.getLogger(FemaleImmatureAttributes.class.getName());
    
    /**
     * This constructor is provided only to facilitate the ServiceProvider functionality.
     * DO NOT USE IT!!
     */
    public FemaleImmatureAttributes(){
        super("NULL");
        finishInstantiation();
    }
     ...
     */
    public FemaleImmatureAttributes(String typeName) {
        super(typeName);
        finishInstantiation();
    }
    ...
    @Override
    public Object clone() {
        FemaleImmatureAttributes clone = new FemaleImmatureAttributes(typeName);
     ...
     */
    @Override
    public FemaleImmatureAttributes createInstance(final String[] strv) {
        FemaleImmatureAttributes atts = new FemaleImmatureAttributes(strv[0]);//this sets atts.typeName
        atts.setValues(strv);
        return atts;
    }
...
//        tmpMapValues.put(PROP_size,       new Double(0));
    ...
    public void setValues(final String[] strv) {
        ...
        try {
            ...
            String[] aKeys = new String[FemaleImmatureAttributes.allKeys.size()];
            aKeys = FemaleImmatureAttributes.allKeys.toArray(aKeys);
