...
/**
 * DisMELS class representing attributes for adolescent male snow crab.
 */
@ServiceProvider(service=wts.models.DisMELS.framework.LifeStageAttributesInterface.class)
public class MaleAdolescentAttributes extends AbstractBenthicStageAttributes {
     ...
     * DO NOT USE IT!!
     */
    public MaleAdolescentAttributes(){
        super("NULL");
        finishInstantiation();
    }
     ...
     */
    public MaleAdolescentAttributes(String typeName) {
        super(typeName);
        finishInstantiation();
    }
    ...
    @Override
    public Object clone() {
        MaleAdolescentAttributes clone = new MaleAdolescentAttributes(typeName);
     ...
     */
    @Override
    public MaleAdolescentAttributes createInstance(final String[] strv) {
        MaleAdolescentAttributes atts = new MaleAdolescentAttributes(strv[0]);//this sets atts.typeName
        atts.setValues(strv);
        return atts;
    }
...
//        tmpMapValues.put(PROP_size,       new Double(0));
    ...
    public void setValues(final String[] strv) {
        ...
        try {
            ...
            String[] aKeys = new String[MaleAdolescentAttributes.allKeys.size()];
            aKeys = MaleAdolescentAttributes.allKeys.toArray(aKeys);
    ...
    /**
     * Gets the attribute value, formatted as a String, associated with the key.
     * 
     * @param key - the key used to retieve the attribute
     * @return - the attribute value, formatted as a String
     */
    @Override
