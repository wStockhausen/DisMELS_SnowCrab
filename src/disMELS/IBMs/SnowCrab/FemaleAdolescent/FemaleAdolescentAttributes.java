/*
 * FemaleAdolescentAttributes.java
 */
...
public class FemaleAdolescentAttributes extends AbstractBenthicStageAttributes {
...
//    public static final String PROP_size   = "size [mm]";
    ...
    /** class logger */
    private static final Logger logger = Logger.getLogger(FemaleAdolescentAttributes.class.getName());
    
    /**
     * This constructor is provided only to facilitate the ServiceProvider functionality.
     * DO NOT USE IT!!
     */
    public FemaleAdolescentAttributes(){
        super("NULL");
        finishInstantiation();
    }
     ...
     */
    public FemaleAdolescentAttributes(String typeName) {
        super(typeName);
        finishInstantiation();
    }
    ...
    @Override
    public Object clone() {
        FemaleAdolescentAttributes clone = new FemaleAdolescentAttributes(typeName);
     ...
     */
    @Override
    public FemaleAdolescentAttributes createInstance(final String[] strv) {
        FemaleAdolescentAttributes atts = new FemaleAdolescentAttributes(strv[0]);//this sets atts.typeName
        atts.setValues(strv);
        return atts;
    }
...
//        tmpMapValues.put(PROP_size,       new Double(0));
    ...
    public void setValues(final String[] strv) {
        ...
        try {
            ...
            String[] aKeys = new String[FemaleAdolescentAttributes.allKeys.size()];
            aKeys = FemaleAdolescentAttributes.allKeys.toArray(aKeys);
