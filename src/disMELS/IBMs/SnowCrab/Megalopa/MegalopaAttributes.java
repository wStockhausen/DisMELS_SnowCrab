...
/**
 * DisMELS class representing attributes for snow crab megalopae.
 */
@ServiceProvider(service=wts.models.DisMELS.framework.LifeStageAttributesInterface.class)
public class MegalopaAttributes extends AbstractPelagicStageAttributes {
...
//    public static final String PROP_size   = "size [mm]";
    ...
    /** class logger */
    private static final Logger logger = Logger.getLogger(MegalopaAttributes.class.getName());
    
    /**
     * This constructor is provided only to facilitate the ServiceProvider functionality.
     * DO NOT USE IT!!
     */
    public MegalopaAttributes(){
        super("NULL");
        finishInstantiation();
    }
     ...
     */
    public MegalopaAttributes(String typeName) {
        super(typeName);
        finishInstantiation();
    }
     ...
     */
    @Override
    public MegalopaAttributes createInstance(final String[] strv) {
        MegalopaAttributes atts = new MegalopaAttributes(strv[0]);//this sets atts.typeName
        atts.setValues(strv);
        return atts;
    }
