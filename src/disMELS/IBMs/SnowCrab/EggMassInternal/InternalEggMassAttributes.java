/*
 * InternalEggMassAttributes.java
*/
...
/**
 * DisMELS class encapsulating attributes for an internally-developing egg mass in a 
 * post-immature female snow crab.
 */
@ServiceProvider(service=wts.models.DisMELS.framework.LifeStageAttributesInterface.class)
public class InternalEggMassAttributes extends AbstractLHSAttributes2 {
    ...
    public static final String PROP_pH          = "ocean pH";
    ...
    private static final Logger logger = Logger.getLogger(InternalEggMassAttributes.class.getName());
    
    /**
     * This constructor is provided only to facilitate the ServiceProvider functionality.
     * DO NOT USE IT!!
     */
    public InternalEggMassAttributes(){
        super("NULL");
        finishInstantiation();
    }
     ...
     */
    public InternalEggMassAttributes(String typeName) {
        super(typeName);
        finishInstantiation();
    }
    ...
    @Override
    public Object clone() {
        InternalEggMassAttributes clone = new InternalEggMassAttributes(typeName);
     ...
     */
    @Override
    public InternalEggMassAttributes createInstance(final String[] strv) {
        InternalEggMassAttributes atts = new InternalEggMassAttributes(strv[0]);//this sets atts.typeName
        atts.setValues(strv);
        return atts;
    }
    ...
    private void finishInstantiation(){
        ...
        tmpMapValues.put(PROP_pH,        new Double(-1));
    ...
    public void setValues(final String[] strv) {
        ...
        try {
            ...
            String[] aKeys = new String[InternalEggMassAttributes.allKeys.size()];
            aKeys = InternalEggMassAttributes.allKeys.toArray(aKeys);
