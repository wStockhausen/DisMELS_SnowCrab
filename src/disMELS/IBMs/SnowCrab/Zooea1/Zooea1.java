 ...
 /
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        ...
        if (newAtts instanceof ExtrudedEggMassAttributes) {
            ...
            akey = Zooea1Attributes.PROP_size;    atts.setValue(akey, initialSize);
    ...
    private void setParameterValues() {
        ...
        initialSize = 
                params.getValue(Zooea1Parameters.PARAM_initialSize,initialSize);
        initialWeight = 
        ...
        minSize = 
                params.getValue(Zooea1Parameters.PARAM_minSize,minSize);
