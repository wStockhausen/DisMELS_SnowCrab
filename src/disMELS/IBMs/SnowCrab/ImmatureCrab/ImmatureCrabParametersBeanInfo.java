 ...
 */
public class ImmatureCrabParametersBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( disMELS.IBMs.SnowCrab.ImmatureCrab.ImmatureCrabParameters.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_CSV] = new PropertyDescriptor ( "CSV", disMELS.IBMs.SnowCrab.ImmatureCrab.ImmatureCrabParameters.class, "getCSV", null ); // NOI18N
            properties[PROPERTY_CSVHeader] = new PropertyDescriptor ( "CSVHeader", disMELS.IBMs.SnowCrab.ImmatureCrab.ImmatureCrabParameters.class, "getCSVHeader", null ); // NOI18N
            properties[PROPERTY_IBMFunctionCategories] = new PropertyDescriptor ( "IBMFunctionCategories", disMELS.IBMs.SnowCrab.ImmatureCrab.ImmatureCrabParameters.class, "getIBMFunctionCategories", null ); // NOI18N
            properties[PROPERTY_IBMParameterKeys] = new PropertyDescriptor ( "IBMParameterKeys", disMELS.IBMs.SnowCrab.ImmatureCrab.ImmatureCrabParameters.class, "getIBMParameterKeys", null ); // NOI18N
            properties[PROPERTY_keys] = new PropertyDescriptor ( "keys", disMELS.IBMs.SnowCrab.ImmatureCrab.ImmatureCrabParameters.class, "getKeys", null ); // NOI18N
            properties[PROPERTY_typeName] = new PropertyDescriptor ( "typeName", disMELS.IBMs.SnowCrab.ImmatureCrab.ImmatureCrabParameters.class, "getTypeName", "setTypeName" ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( disMELS.IBMs.SnowCrab.ImmatureCrab.ImmatureCrabParameters.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_clone0] = new MethodDescriptor(disMELS.IBMs.SnowCrab.ImmatureCrab.ImmatureCrabParameters.class.getMethod("clone", new Class[] {})); // NOI18N
            methods[METHOD_clone0].setDisplayName ( "" );
            methods[METHOD_createInstance1] = new MethodDescriptor(disMELS.IBMs.SnowCrab.ImmatureCrab.ImmatureCrabParameters.class.getMethod("createInstance", new Class[] {java.lang.String[].class})); // NOI18N
