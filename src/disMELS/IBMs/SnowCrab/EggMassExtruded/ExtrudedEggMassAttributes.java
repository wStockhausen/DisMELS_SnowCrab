/*
 * ExtrudedEggMassAttributes.java
*/
...
/**
 * DisMELS class encapsulating attributes for an extruded clutch of eggs on the abdomen of a post-adolescent
 * female snow crab.
 * 
...
public class ExtrudedEggMassAttributes extends AbstractLHSAttributes2 {
    ...
    private static final Logger logger = Logger.getLogger(ExtrudedEggMassAttributes.class.getName());
    
    /**
     * This constructor is provided only to facilitate the ServiceProvider functionality.
     * DO NOT USE IT!!
     */
    public ExtrudedEggMassAttributes(){
        super("NULL");
        finishInstantiation();
    }
     ...
     */
    public ExtrudedEggMassAttributes(String typeName) {
        super(typeName);
        finishInstantiation();
    }
    ...
    @Override
    public Object clone() {
        ExtrudedEggMassAttributes clone = new ExtrudedEggMassAttributes(typeName);
     ...
     */
    @Override
    public ExtrudedEggMassAttributes createInstance(final String[] strv) {
        ExtrudedEggMassAttributes atts = new ExtrudedEggMassAttributes(strv[0]);//this sets atts.typeName
        atts.setValues(strv);
        return atts;
    }
    ...
    public void setValues(final String[] strv) {
        ...
        try {
            ...
            String[] aKeys = new String[ExtrudedEggMassAttributes.allKeys.size()];
            aKeys = ExtrudedEggMassAttributes.allKeys.toArray(aKeys);
