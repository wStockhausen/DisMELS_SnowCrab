/*
 * ExtrudedEggMassAttributesCustomizer.java
 *
 ...
 */
public class ExtrudedEggMassAttributesCustomizer extends AttributesCustomizer {

    private ExtrudedEggMassAttributes attributes = null;
    
    /**
     * Creates new customizer EggStageAttributesCustomizer
     */
    public ExtrudedEggMassAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof ExtrudedEggMassAttributes) {
            setAttributes((ExtrudedEggMassAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof ExtrudedEggMassAttributes) {
            attributes = (ExtrudedEggMassAttributes) newAtts;
