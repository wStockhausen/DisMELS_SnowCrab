...
public class ImmatureMaleParameters extends AbstractLHSParameters {
    ...
    private static final Logger logger = Logger.getLogger(ImmatureMaleParameters.class.getName());
     ...
     * Creates a new instance of EggStageParameters
     */
    public ImmatureMaleParameters(String typeName) {
   ...
   public void selectIBMFunctionForCategory(String cat, String key){
    ...
    @Override
    public Object clone() {
        ImmatureMaleParameters clone = null;
        try {
            clone = (ImmatureMaleParameters) super.clone();
     ...
     */
    @Override
    public ImmatureMaleParameters createInstance(final String[] strv) {
        int c = 0;
        ImmatureMaleParameters params = new ImmatureMaleParameters(strv[c++]);
