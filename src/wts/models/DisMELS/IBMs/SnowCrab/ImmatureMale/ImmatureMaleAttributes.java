...
public class ImmatureMaleAttributes extends AbstractLHSAttributes2 {
    ...
    private static final Logger logger = Logger.getLogger(ImmatureMaleAttributes.class.getName());
    
    /**
     * This constructor is provided only to facilitate the ServiceProvider functionality.
     * DO NOT USE IT!!
     */
    public ImmatureMaleAttributes(){
        super("NULL");
        finishInstantiation();
    }
     ...
     */
    public ImmatureMaleAttributes(String typeName) {
        super(typeName);
        finishInstantiation();
    }
    ...
    @Override
    public Object clone() {
        ImmatureMaleAttributes clone = new ImmatureMaleAttributes(typeName);
     ...
     */
    @Override
    public ImmatureMaleAttributes createInstance(final String[] strv) {
        ImmatureMaleAttributes atts = new ImmatureMaleAttributes(strv[0]);//this sets atts.typeName
        atts.setValues(strv);
        return atts;
    }
    ...
    public void setValues(final String[] strv) {
        ...
        try {
            ...
            String[] aKeys = new String[ImmatureMaleAttributes.allKeys.size()];
            aKeys = ImmatureMaleAttributes.allKeys.toArray(aKeys);
