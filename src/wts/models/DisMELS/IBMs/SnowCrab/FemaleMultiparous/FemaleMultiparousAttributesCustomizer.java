/*
 * FemaleMultiparousAttributesCustomizer.java
 *
 ...
 */
public class FemaleMultiparousAttributesCustomizer extends AttributesCustomizer {

    private boolean showHorizPos = true;
    private boolean showVertPos = true;
    
    private FemaleMultiparousAttributes attributes = null;
    
    /**
     * Creates new customizer
     */
    public FemaleMultiparousAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof FemaleMultiparousAttributes) {
            setAttributes((FemaleMultiparousAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof FemaleMultiparousAttributes) {
            attributes = (FemaleMultiparousAttributes) newAtts;
