/*
 * FemaleMultiparousParameters.java
 *
...
public class FemaleMultiparousParameters extends AbstractLHSParameters {
    ...
    private static final Logger logger = Logger.getLogger(FemaleMultiparousParameters.class.getName());
     ...
     */
    public FemaleMultiparousParameters() {
     ...
     * Creates a new instance of AdultStageParameters
     */
    public FemaleMultiparousParameters(String typeName) {
   ...
   public void selectIBMFunctionForCategory(String cat, String key){
    ...
    @Override
    public Object clone() {
        FemaleMultiparousParameters clone = null;
        try {
            clone = (FemaleMultiparousParameters) super.clone();
     ...
     */
    @Override
    public FemaleMultiparousParameters createInstance(final String[] strv) {
        int c = 0;
        FemaleMultiparousParameters params = new FemaleMultiparousParameters(strv[c++]);
