/*
 * MaleAdultAttributesCustomizer.java
 *
 ...
 */
public class MaleAdultAttributesCustomizer extends AttributesCustomizer {

    private boolean showHorizPos = true;
    private boolean showVertPos = true;
    
    private MaleAdultAttributes attributes = null;
    
    /**
     * Creates new customizer EggStageAttributesCustomizer
     */
    public MaleAdultAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof MaleAdultAttributes) {
            setAttributes((MaleAdultAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof MaleAdultAttributes) {
            attributes = (MaleAdultAttributes) newAtts;
