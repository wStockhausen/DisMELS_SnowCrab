/*
 * MegalopaStageAttributesCustomizer.java
 *
 ...
 */
public class MegalopaStageAttributesCustomizer extends AttributesCustomizer {

    private MegalopaStageAttributes attributes = null;
    
    /**
     * Creates new customizer LarvaStageAttributesCustomizer
     */
    public MegalopaStageAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof MegalopaStageAttributes) {
            setAttributes((MegalopaStageAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof MegalopaStageAttributes) {
            attributes = (MegalopaStageAttributes) newAtts;
