...
import wts.models.DisMELS.IBMs.SnowCrab.Megalopa.MegalopaStage;
import wts.models.DisMELS.IBMs.SnowCrab.Zooea1.Zooea1StageAttributes;
...
/**
 * Life stage representing the zooea 2 stage for snow crab.
 * 
 * @author William Stockhausen
 */
@ServiceProvider(service=LifeStageInterface.class)
public class Zooea2Stage extends AbstractLHS {
    ...
    public static final String attributesClass = Zooea2StageAttributes.class.getName();
    /* Class for parameters */
    public static final String parametersClass = Zooea2StageParameters.class.getName();
...
//            wts.models.DisMELS.IBMs.Arrowtooth.EggStage.EggStagePointFT.class.getName();
    ...
    public static final String[] nextLHSClasses = new String[]{Zooea2Stage.class.getName(),
                                                               MegalopaStage.class.getName()};
    ...
    protected Zooea2StageAttributes atts = null;
    /* life stage parameters object */
    protected Zooea2StageParameters params = null;
    ...
    /** logger for class */
    private static final Logger logger = Logger.getLogger(Zooea2Stage.class.getName());
     ...
     * DO NOT DELETE THIS CONSTRUCTOR!!
     */
    public Zooea2Stage(String typeName) 
                throws InstantiationException, IllegalAccessException {
        super(typeName);
        atts = new Zooea2StageAttributes(typeName);
        ...
        params = (Zooea2StageParameters) LHS_Factory.createParameters(typeName);
     ...
     */
    @Override
    public Zooea2Stage createInstance(String[] strv) 
                        throws InstantiationException, IllegalAccessException {
        LifeStageAttributesInterface theAtts = LHS_Factory.createAttributes(strv);
        Zooea2Stage lhs = createInstance(theAtts);
        return lhs;
    }
     ...
     */
    @Override
    public Zooea2Stage createInstance(LifeStageAttributesInterface theAtts)
                        throws InstantiationException, IllegalAccessException {
        Zooea2Stage lhs = null;
        if (theAtts instanceof Zooea2StageAttributes) {
            lhs = new Zooea2Stage(theAtts.getTypeName());
     ...
     */
    @Override
    public Zooea2StageAttributes getAttributes() {
        return atts;
    }
     ...
     * @param newAtts - should be instance of EggStageAttributes or Zooea2StageAttributes
     */
    @Override
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        ...
        if (newAtts instanceof Zooea1StageAttributes) {
            //get initial values for size and weight
            String akey; String pkey;
            akey = Zooea2StageAttributes.PROP_size;    atts.setValue(akey, initialSize);
            akey = Zooea2StageAttributes.PROP_weight;  atts.setValue(akey, initialWeight);
        }
     ...
     */
    @Override
    public Zooea2StageParameters getParameters() {
        return params;
    }
    ...
    public void setParameters(LifeStageParametersInterface newParams) {
        if (newParams instanceof Zooea2StageParameters) {
            params = (Zooea2StageParameters) newParams;
    ...
    private void setIBMFunctions(){
        fcnGrowth  = params.getSelectedIBMFunctionForCategory(Zooea2StageParameters.FCAT_Growth);
        fcnMort    = params.getSelectedIBMFunctionForCategory(Zooea2StageParameters.FCAT_Mortality);
        fcnVM      = params.getSelectedIBMFunctionForCategory(Zooea2StageParameters.FCAT_VerticalMovement);
        fcnVV      = params.getSelectedIBMFunctionForCategory(Zooea2StageParameters.FCAT_VerticalVelocity);
    }
    ...
    private void setParameterValues() {
        isSuperIndividual = 
                params.getValue(Zooea2StageParameters.PARAM_isSuperIndividual,isSuperIndividual);
        horizRWP = 
                params.getValue(Zooea2StageParameters.PARAM_horizRWP,horizRWP);
        initialSize = 
                params.getValue(Zooea2StageParameters.PARAM_initialSize,initialSize);
        initialWeight = 
                params.getValue(Zooea2StageParameters.PARAM_initialWeight,initialWeight);
        minStageDuration = 
                params.getValue(Zooea2StageParameters.PARAM_minStageDuration,minStageDuration);
        maxStageDuration = 
                params.getValue(Zooea2StageParameters.PARAM_maxStageDuration,maxStageDuration);
        minSize = 
                params.getValue(Zooea2StageParameters.PARAM_minSize,minSize);
        randomizeTransitions = 
                params.getValue(Zooea2StageParameters.PARAM_randomizeTransitions,true);
    }
    ...
    @Override
    public Object clone() {
        Zooea2Stage clone = null;
        try {
            clone = (Zooea2Stage) super.clone();
...
//                if (xPos<0) xPos=xPos+360;
    ...
    protected void updateAttributes() {
        ...
        atts.setValue(Zooea2StageAttributes.PROP_size,size);
        atts.setValue(Zooea2StageAttributes.PROP_weight,weight);
        atts.setValue(Zooea2StageAttributes.PROP_salinity,salinity);
        atts.setValue(Zooea2StageAttributes.PROP_temperature,temperature);
    }
    ...
    protected void updateVariables() {
        ...
        size        = atts.getValue(Zooea2StageAttributes.PROP_size,size);
        weight      = atts.getValue(Zooea2StageAttributes.PROP_weight,weight);
        salinity    = atts.getValue(Zooea2StageAttributes.PROP_salinity,salinity);
        temperature = atts.getValue(Zooea2StageAttributes.PROP_temperature,temperature);
    }
