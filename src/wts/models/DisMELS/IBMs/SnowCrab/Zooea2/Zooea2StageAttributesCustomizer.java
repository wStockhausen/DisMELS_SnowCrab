/*
 * Zooea2StageAttributesCustomizer.java
 *
 ...
 */
public class Zooea2StageAttributesCustomizer extends AttributesCustomizer {

    private Zooea2StageAttributes attributes = null;
    
    /**
     * Creates new customizer Zooea2StageAttributesCustomizer
     */
    public Zooea2StageAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof Zooea2StageAttributes) {
            setAttributes((Zooea2StageAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof Zooea2StageAttributes) {
            attributes = (Zooea2StageAttributes) newAtts;
