...
/**
 * DisMELS class representing attributes for the snow crab zooea 2 stage.
 * 
 * @author William Stockhausen
 */
@ServiceProvider(service=wts.models.DisMELS.framework.LifeStageAttributesInterface.class)
public class Zooea2StageAttributes extends AbstractLHSAttributes2 {
    ...
    private static final Logger logger = Logger.getLogger(Zooea2StageAttributes.class.getName());
    
    /**
     * This constructor is provided only to facilitate the ServiceProvider functionality.
     * DO NOT USE IT!!
     */
    public Zooea2StageAttributes(){
        super("NULL");
        finishInstantiation();
    }
     ...
     */
    public Zooea2StageAttributes(String typeName) {
        super(typeName);
        finishInstantiation();
    }
    ...
    @Override
    public Object clone() {
        Zooea2StageAttributes clone = new Zooea2StageAttributes(typeName);
     ...
     */
    @Override
    public Zooea2StageAttributes createInstance(final String[] strv) {
        Zooea2StageAttributes atts = new Zooea2StageAttributes(strv[0]);//this sets atts.typeName
        atts.setValues(strv);
        return atts;
    }
    ...
    public void setValues(final String[] strv) {
        ...
        try {
            ...
            String[] aKeys = new String[Zooea2StageAttributes.allKeys.size()];
            aKeys = Zooea2StageAttributes.allKeys.toArray(aKeys);
