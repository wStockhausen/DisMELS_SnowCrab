...
public class Zooea2StageParameters extends AbstractLHSParameters {
    ...
    private static final Logger logger = Logger.getLogger(Zooea2StageParameters.class.getName());
     ...
     * Creates a new instance of EggStageParameters
     */
    public Zooea2StageParameters(String typeName) {
   ...
   public void selectIBMFunctionForCategory(String cat, String key){
    ...
    @Override
    public Object clone() {
        Zooea2StageParameters clone = null;
        try {
            clone = (Zooea2StageParameters) super.clone();
     ...
     */
    @Override
    public Zooea2StageParameters createInstance(final String[] strv) {
        int c = 0;
        Zooea2StageParameters params = new Zooea2StageParameters(strv[c++]);
