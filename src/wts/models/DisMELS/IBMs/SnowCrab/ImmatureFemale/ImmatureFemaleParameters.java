...
public class ImmatureFemaleParameters extends AbstractLHSParameters {
    ...
    private static final Logger logger = Logger.getLogger(ImmatureFemaleParameters.class.getName());
     ...
     */
    public ImmatureFemaleParameters() {
     ...
     * Creates a new instance of EggStageParameters
     */
    public ImmatureFemaleParameters(String typeName) {
   ...
   public void selectIBMFunctionForCategory(String cat, String key){
    ...
    @Override
    public Object clone() {
        ImmatureFemaleParameters clone = null;
        try {
            clone = (ImmatureFemaleParameters) super.clone();
     ...
     */
    @Override
    public ImmatureFemaleParameters createInstance(final String[] strv) {
        int c = 0;
        ImmatureFemaleParameters params = new ImmatureFemaleParameters(strv[c++]);
