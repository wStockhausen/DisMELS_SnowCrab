/*
 * ImmatureFemaleAttributesCustomizer.java
 *
 ...
 */
public class ImmatureFemaleAttributesCustomizer extends AttributesCustomizer {

    private ImmatureFemaleAttributes attributes = null;
    
    /**
     * Creates new customizer BenthicJuvenileStageAttributesCustomizer
     */
    public ImmatureFemaleAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof ImmatureFemaleAttributes) {
            setAttributes((ImmatureFemaleAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof ImmatureFemaleAttributes) {
            attributes = (ImmatureFemaleAttributes) newAtts;
