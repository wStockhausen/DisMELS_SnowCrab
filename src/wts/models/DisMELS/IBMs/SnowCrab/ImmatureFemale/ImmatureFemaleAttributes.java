...
public class ImmatureFemaleAttributes extends AbstractLHSAttributes2 {
    ...
    private static final Logger logger = Logger.getLogger(ImmatureFemaleAttributes.class.getName());
    
    /**
     * This constructor is provided only to facilitate the ServiceProvider functionality.
     * DO NOT USE IT!!
     */
    public ImmatureFemaleAttributes(){
        super("NULL");
        finishInstantiation();
    }
     ...
     */
    public ImmatureFemaleAttributes(String typeName) {
        super(typeName);
        finishInstantiation();
    }
    ...
    @Override
    public Object clone() {
        ImmatureFemaleAttributes clone = new ImmatureFemaleAttributes(typeName);
     ...
     */
    @Override
    public ImmatureFemaleAttributes createInstance(final String[] strv) {
        ImmatureFemaleAttributes atts = new ImmatureFemaleAttributes(strv[0]);//this sets atts.typeName
        atts.setValues(strv);
        return atts;
    }
    ...
    public void setValues(final String[] strv) {
        ...
        try {
            ...
            String[] aKeys = new String[ImmatureFemaleAttributes.allKeys.size()];
            aKeys = ImmatureFemaleAttributes.allKeys.toArray(aKeys);
