...
public class Zooea1StageParameters extends AbstractLHSParameters {
    ...
    private static final Logger logger = Logger.getLogger(Zooea1StageParameters.class.getName());
     ...
     * Creates a new instance of EggStageParameters
     */
    public Zooea1StageParameters(String typeName) {
   ...
   public void selectIBMFunctionForCategory(String cat, String key){
    ...
    @Override
    public Object clone() {
        Zooea1StageParameters clone = null;
        try {
            clone = (Zooea1StageParameters) super.clone();
     ...
     */
    @Override
    public Zooea1StageParameters createInstance(final String[] strv) {
        int c = 0;
        Zooea1StageParameters params = new Zooea1StageParameters(strv[c++]);
