/*
 * Zooea1StageAttributes.java
 *
 * Created on Spetember 26, 2017.
 *
 */
...
/**
 * DisMELS class representing attributes for the snow crab zooea 1 stage.
 * 
 * @author William Stockhausen
 */
@ServiceProvider(service=wts.models.DisMELS.framework.LifeStageAttributesInterface.class)
public class Zooea1StageAttributes extends AbstractLHSAttributes2 {
    
    /** Number of new attributes defined by this class */
    public static final int numNewAttributes = 4;
    
    public static final String PROP_size   = "size [mm CL]";
    ...
    private static final Logger logger = Logger.getLogger(Zooea1StageAttributes.class.getName());
    
    /**
     * This constructor is provided only to facilitate the ServiceProvider functionality.
     * DO NOT USE IT!!
     */
    public Zooea1StageAttributes(){
        super("NULL");
        finishInstantiation();
    }
     ...
     */
    public Zooea1StageAttributes(String typeName) {
        super(typeName);
        finishInstantiation();
    }
    ...
    @Override
    public Object clone() {
        Zooea1StageAttributes clone = new Zooea1StageAttributes(typeName);
     ...
     */
    @Override
    public Zooea1StageAttributes createInstance(final String[] strv) {
        Zooea1StageAttributes atts = new Zooea1StageAttributes(strv[0]);//this sets atts.typeName
        atts.setValues(strv);
        return atts;
    }
    ...
    public void setValues(final String[] strv) {
        ...
        try {
            ...
            String[] aKeys = new String[Zooea1StageAttributes.allKeys.size()];
            aKeys = Zooea1StageAttributes.allKeys.toArray(aKeys);
