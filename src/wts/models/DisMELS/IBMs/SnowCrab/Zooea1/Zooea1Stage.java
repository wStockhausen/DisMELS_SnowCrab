...
import wts.models.DisMELS.IBMs.SnowCrab.Zooea2.Zooea2Stage;
...
public class Zooea1Stage extends AbstractLHS {
    ...
    public static final String attributesClass = Zooea1StageAttributes.class.getName();
    /* Class for parameters */
    public static final String parametersClass = Zooea1StageParameters.class.getName();
...
//            wts.models.DisMELS.IBMs.Arrowtooth.EggStage.EggStagePointFT.class.getName();
    ...
    public static final String[] nextLHSClasses = new String[]{Zooea1Stage.class.getName(),
                                                               Zooea2Stage.class.getName()};
    ...
    protected Zooea1StageAttributes atts = null;
    /* life stage parameters object */
    protected Zooea1StageParameters params = null;
    ...
    /** logger for class */
    private static final Logger logger = Logger.getLogger(Zooea1Stage.class.getName());
     ...
     * DO NOT DELETE THIS CONSTRUCTOR!!
     */
    public Zooea1Stage(String typeName) 
                throws InstantiationException, IllegalAccessException {
        super(typeName);
        atts = new Zooea1StageAttributes(typeName);
        ...
        params = (Zooea1StageParameters) LHS_Factory.createParameters(typeName);
     ...
     */
    @Override
    public Zooea1Stage createInstance(String[] strv) 
                        throws InstantiationException, IllegalAccessException {
        LifeStageAttributesInterface theAtts = LHS_Factory.createAttributes(strv);
        Zooea1Stage lhs = createInstance(theAtts);
        return lhs;
    }
     ...
     */
    @Override
    public Zooea1Stage createInstance(LifeStageAttributesInterface theAtts)
                        throws InstantiationException, IllegalAccessException {
        Zooea1Stage lhs = null;
        if (theAtts instanceof Zooea1StageAttributes) {
            lhs = new Zooea1Stage(theAtts.getTypeName());
     ...
     */
    @Override
    public Zooea1StageAttributes getAttributes() {
        return atts;
    }
 ...
 Attribute values are set using Zooea1StageAttributes.setValues(String[]).
 Side effects:
 ...
 /
     ...
     * @param newAtts - should be instance of EggStageAttributes or Zooea1StageAttributes
     */
    @Override
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        ...
        if (newAtts instanceof EggStageAttributes) {
            ...
            akey = Zooea1StageAttributes.PROP_size;    atts.setValue(akey, initialSize);
            akey = Zooea1StageAttributes.PROP_weight;  atts.setValue(akey, initialWeight);
        }
     ...
     */
    @Override
    public Zooea1StageParameters getParameters() {
        return params;
    }
    ...
    public void setParameters(LifeStageParametersInterface newParams) {
        if (newParams instanceof Zooea1StageParameters) {
            params = (Zooea1StageParameters) newParams;
    ...
    private void setIBMFunctions(){
        fcnGrowth  = params.getSelectedIBMFunctionForCategory(Zooea1StageParameters.FCAT_Growth);
        fcnMort    = params.getSelectedIBMFunctionForCategory(Zooea1StageParameters.FCAT_Mortality);
        fcnVM      = params.getSelectedIBMFunctionForCategory(Zooea1StageParameters.FCAT_VerticalMovement);
        fcnVV      = params.getSelectedIBMFunctionForCategory(Zooea1StageParameters.FCAT_VerticalVelocity);
    }
    ...
    private void setParameterValues() {
        isSuperIndividual = 
                params.getValue(Zooea1StageParameters.PARAM_isSuperIndividual,isSuperIndividual);
        horizRWP = 
                params.getValue(Zooea1StageParameters.PARAM_horizRWP,horizRWP);
        initialSize = 
                params.getValue(Zooea1StageParameters.PARAM_initialSize,initialSize);
        initialWeight = 
                params.getValue(Zooea1StageParameters.PARAM_initialWeight,initialWeight);
        minStageDuration = 
                params.getValue(Zooea1StageParameters.PARAM_minStageDuration,minStageDuration);
        maxStageDuration = 
                params.getValue(Zooea1StageParameters.PARAM_maxStageDuration,maxStageDuration);
        minSize = 
                params.getValue(Zooea1StageParameters.PARAM_minSize,minSize);
        randomizeTransitions = 
                params.getValue(Zooea1StageParameters.PARAM_randomizeTransitions,true);
    }
    ...
    @Override
    public Object clone() {
        Zooea1Stage clone = null;
        try {
            clone = (Zooea1Stage) super.clone();
...
//                if (xPos<0) xPos=xPos+360;
    ...
    protected void updateAttributes() {
        ...
        atts.setValue(Zooea1StageAttributes.PROP_size,size);
        atts.setValue(Zooea1StageAttributes.PROP_weight,weight);
        atts.setValue(Zooea1StageAttributes.PROP_salinity,salinity);
        atts.setValue(Zooea1StageAttributes.PROP_temperature,temperature);
    }
    ...
    protected void updateVariables() {
        ...
        size        = atts.getValue(Zooea1StageAttributes.PROP_size,size);
        weight      = atts.getValue(Zooea1StageAttributes.PROP_weight,weight);
        salinity    = atts.getValue(Zooea1StageAttributes.PROP_salinity,salinity);
        temperature = atts.getValue(Zooea1StageAttributes.PROP_temperature,temperature);
    }
