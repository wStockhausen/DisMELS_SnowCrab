/*
 * Zooea1StageAttributesCustomizer.java
 *
 ...
 */
public class Zooea1StageAttributesCustomizer extends AttributesCustomizer {

    private Zooea1StageAttributes attributes = null;
    
    /**
     * Creates new customizer LarvaStageAttributesCustomizer
     */
    public Zooea1StageAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof Zooea1StageAttributes) {
            setAttributes((Zooea1StageAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof Zooea1StageAttributes) {
            attributes = (Zooea1StageAttributes) newAtts;
