/*
 * FemaleImmatureAttributesCustomizer.java
 *
 ...
 */
public class FemaleImmatureAttributesCustomizer extends AttributesCustomizer {

    private FemaleImmatureAttributes attributes = null;
    
    /**
     * Creates new customizer BenthicJuvenileStageAttributesCustomizer
     */
    public FemaleImmatureAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof FemaleImmatureAttributes) {
            setAttributes((FemaleImmatureAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof FemaleImmatureAttributes) {
            attributes = (FemaleImmatureAttributes) newAtts;
