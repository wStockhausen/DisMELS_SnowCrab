...
public class MaleImmatureAttributes extends AbstractLHSAttributes2 {
    ...
    private static final Logger logger = Logger.getLogger(MaleImmatureAttributes.class.getName());
    
    /**
     * This constructor is provided only to facilitate the ServiceProvider functionality.
     * DO NOT USE IT!!
     */
    public MaleImmatureAttributes(){
        super("NULL");
        finishInstantiation();
    }
     ...
     */
    public MaleImmatureAttributes(String typeName) {
        super(typeName);
        finishInstantiation();
    }
    ...
    @Override
    public Object clone() {
        MaleImmatureAttributes clone = new MaleImmatureAttributes(typeName);
     ...
     */
    @Override
    public MaleImmatureAttributes createInstance(final String[] strv) {
        MaleImmatureAttributes atts = new MaleImmatureAttributes(strv[0]);//this sets atts.typeName
        atts.setValues(strv);
        return atts;
    }
    ...
    public void setValues(final String[] strv) {
        ...
        try {
            ...
            String[] aKeys = new String[MaleImmatureAttributes.allKeys.size()];
            aKeys = MaleImmatureAttributes.allKeys.toArray(aKeys);
