/*
 * MaleImmatureAttributesCustomizer.java
 *
 ...
 */
public class MaleImmatureAttributesCustomizer extends AttributesCustomizer {

    private MaleImmatureAttributes attributes = null;
    
    /**
     * Creates new customizer BenthicJuvenileStageAttributesCustomizer
     */
    public MaleImmatureAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof MaleImmatureAttributes) {
            setAttributes((MaleImmatureAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof MaleImmatureAttributes) {
            attributes = (MaleImmatureAttributes) newAtts;
