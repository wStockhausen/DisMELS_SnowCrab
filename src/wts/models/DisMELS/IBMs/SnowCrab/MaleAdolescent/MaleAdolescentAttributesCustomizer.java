/*
 * MaleAdolescentAttributesCustomizer.java
 *
 ...
 */
public class MaleAdolescentAttributesCustomizer extends AttributesCustomizer {

    private boolean showHorizPos = true;
    private boolean showVertPos = true;
    
    private MaleAdolescentAttributes attributes = null;
    
    /**
     * Creates new customizer EggStageAttributesCustomizer
     */
    public MaleAdolescentAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof MaleAdolescentAttributes) {
            setAttributes((MaleAdolescentAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof MaleAdolescentAttributes) {
            attributes = (MaleAdolescentAttributes) newAtts;
