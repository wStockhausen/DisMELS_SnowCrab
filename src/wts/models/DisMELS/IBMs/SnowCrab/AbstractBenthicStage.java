...
//  Methods inherited from LifeHistoryStageIF  
   ...
   public abstract String getReportHeader();
    ...
    protected void updateAttributes() {
        ...
        atts.setValue(AbstractBenthicStageAttributes.PROP_attached,attached);
    ...
    protected void updateVariables() {
        ...
        attached   = atts.getValue(AbstractBenthicStageAttributes.PROP_attached,attached);
        ...
        shellthick  = atts.getValue(AbstractBenthicStageAttributes.PROP_shellcond,shellthick);
