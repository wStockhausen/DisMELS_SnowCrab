/*
 * FemalePrimiparousAttributesCustomizer.java
 *
 ...
 */
public class FemalePrimiparousAttributesCustomizer extends AttributesCustomizer {

    private boolean showHorizPos = true;
    private boolean showVertPos = true;
    
    private FemalePrimiparousAttributes attributes = null;
    
    /**
     * Creates new customizer EggStageAttributesCustomizer
     */
    public FemalePrimiparousAttributesCustomizer() {
        initComponents();
    }
    ...
    public void setObject(Object bean) {
        if (bean instanceof FemalePrimiparousAttributes) {
            setAttributes((FemalePrimiparousAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof FemalePrimiparousAttributes) {
            attributes = (FemalePrimiparousAttributes) newAtts;
