/*
 * FemalePrimiparousAttributes.java
 *
...
public class FemalePrimiparousAttributes extends AbstractLHSAttributes2 {
    ...
    private static final Logger logger = Logger.getLogger(FemalePrimiparousAttributes.class.getName());
    
    /**
     * This constructor is provided only to facilitate the ServiceProvider functionality.
     * DO NOT USE IT!!
     */
    public FemalePrimiparousAttributes(){
        super("NULL");
        finishInstantiation();
    }
     ...
     */
    public FemalePrimiparousAttributes(String typeName) {
        super(typeName);
        finishInstantiation();
    }
    ...
    @Override
    public Object clone() {
        FemalePrimiparousAttributes clone = new FemalePrimiparousAttributes(typeName);
     ...
     */
    @Override
    public FemalePrimiparousAttributes createInstance(final String[] strv) {
        FemalePrimiparousAttributes atts = new FemalePrimiparousAttributes(strv[0]);//this sets atts.typeName
        atts.setValues(strv);
        return atts;
    }
    ...
    public void setValues(final String[] strv) {
        ...
        try {
            ...
            String[] aKeys = new String[FemalePrimiparousAttributes.allKeys.size()];
            aKeys = FemalePrimiparousAttributes.allKeys.toArray(aKeys);
