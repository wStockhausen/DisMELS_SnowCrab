 ...
 */
public class MortalityFunction_OuelletAndSteMarie2017BeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( SnowCrabFunctions.MortalityFunction_OuelletAndSteMarie2017.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( SnowCrabFunctions.MortalityFunction_OuelletAndSteMarie2017.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
