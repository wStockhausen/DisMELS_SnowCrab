...
public class CrabBioenergeticsGrowthFunctionBeanInfo extends SimpleBeanInfo {
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_CSV] = new PropertyDescriptor ( "CSV", SnowCrabFunctions.CrabBioenergeticsGrowthFunction.class, "getCSV", null ); // NOI18N
            properties[PROPERTY_CSVHeader] = new PropertyDescriptor ( "CSVHeader", SnowCrabFunctions.CrabBioenergeticsGrowthFunction.class, "getCSVHeader", null ); // NOI18N
            properties[PROPERTY_description] = new PropertyDescriptor ( "description", SnowCrabFunctions.CrabBioenergeticsGrowthFunction.class, "getDescription", "setDescription" ); // NOI18N
            properties[PROPERTY_fullDescription] = new PropertyDescriptor ( "fullDescription", SnowCrabFunctions.CrabBioenergeticsGrowthFunction.class, "getFullDescription", "setFullDescription" ); // NOI18N
            ...
            properties[PROPERTY_functionType] = new PropertyDescriptor ( "functionType", SnowCrabFunctions.CrabBioenergeticsGrowthFunction.class, "getFunctionType", "setFunctionType" ); // NOI18N
            properties[PROPERTY_parameterNames] = new PropertyDescriptor ( "parameterNames", SnowCrabFunctions.CrabBioenergeticsGrowthFunction.class, "getParameterNames", null ); // NOI18N
            properties[PROPERTY_subfunctionNames] = new PropertyDescriptor ( "subfunctionNames", SnowCrabFunctions.CrabBioenergeticsGrowthFunction.class, "getSubfunctionNames", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( SnowCrabFunctions.CrabBioenergeticsGrowthFunction.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_calculate0] = new MethodDescriptor(SnowCrabFunctions.CrabBioenergeticsGrowthFunction.class.getMethod("calculate", new Class[] {java.lang.Object.class})); // NOI18N
            methods[METHOD_calculate0].setDisplayName ( "" );
            methods[METHOD_clone1] = new MethodDescriptor(SnowCrabFunctions.CrabBioenergeticsGrowthFunction.class.getMethod("clone", new Class[] {})); // NOI18N
            ...
            methods[METHOD_setParameterValue9] = new MethodDescriptor(SnowCrabFunctions.CrabBioenergeticsGrowthFunction.class.getMethod("setParameterValue", new Class[] {java.lang.String.class, java.lang.Object.class})); // NOI18N
